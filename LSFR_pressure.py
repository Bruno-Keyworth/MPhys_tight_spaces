...
FILE_NAME = 'corrected_pressure_test_data.txt'  # Remember to include the extension
SKIP_FIRST_LINE = False
DELIMITER = ','  # Set to space, ' ', if working with .txt file without commas

# Plotting details
PLOT_TITLE = r'Pressure Test '
Y_LABEL = r'Voltage, V'
X_LABEL = r'Pressure, mbar'
AUTO_X_LIMITS = True
X_LIMITS = [0., 10.]  # Not used unless AUTO_X_LIMITS = False
AUTO_Y_LIMITS = True
Y_LIMITS = [0., 10.]  # Not used unless AUTO_Y_LIMITS = False
LINE_COLOUR = 'black'  # See documentation for options:
...
GRID_LINES = True
SAVE_FIGURE = False
FIGURE_NAME = 'Pressure_test_graph'
FIGURE_RESOLUTION = 700  # in dpi
